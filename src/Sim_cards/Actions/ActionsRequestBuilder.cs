...
using System;
namespace Soenneker.Telnyx.OpenApiClient.Sim_cards.Actions
{
    /// <summary>
    ...
    public partial class ActionsRequestBuilder : BaseRequestBuilder
    {
        ...
        {
            get => new global::Soenneker.Telnyx.OpenApiClient.Sim_cards.Actions.Bulk_set_public_ips.Bulk_set_public_ipsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The validate_registration_codes property</summary>
        public global::Soenneker.Telnyx.OpenApiClient.Sim_cards.Actions.Validate_registration_codes.Validate_registration_codesRequestBuilder Validate_registration_codes
        {
            get => new global::Soenneker.Telnyx.OpenApiClient.Sim_cards.Actions.Validate_registration_codes.Validate_registration_codesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Sim_cards.Actions.ActionsRequestBuilder"/> and sets the default values.
        /// </summary>
