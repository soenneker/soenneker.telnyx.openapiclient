...
#nullable enable
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.MessageResponse?> PostAsync(global::Soenneker.Telnyx.OpenApiClient.Models.CreateMessageRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.MessageResponse> PostAsync(global::Soenneker.Telnyx.OpenApiClient.Models.CreateMessageRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.OpenApiClient.Models.MessageResponse>(requestInfo, global::Soenneker.Telnyx.OpenApiClient.Models.MessageResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// &quot;Send a message with a Phone Number, Alphanumeric Sender ID, Short Code or Number Pool.This endpoint allows you to send a message with any messaging resource.Current messaging resources include: long-code, short-code, number-pool, andalphanumeric-sender-id.&quot;
        /// </summary>
