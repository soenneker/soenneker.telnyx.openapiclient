...
namespace Soenneker.Telnyx.OpenApiClient.Sub_number_orders.Item.Requirement_group
{
    ...
    public partial class Requirement_groupRequestBuilder : BaseRequestBuilder
    {
        ...
        public Requirement_groupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sub_number_orders/{%2Did}/requirement_group", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Sub_number_orders.Item.Requirement_group.Requirement_groupRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Requirement_groupRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sub_number_orders/{%2Did}/requirement_group", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.SubNumberOrderRequirementGroupResponse?> PostAsync(global::Soenneker.Telnyx.OpenApiClient.Models.UpdateSubNumberOrderRequirementGroupRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.SubNumberOrderRequirementGroupResponse> PostAsync(global::Soenneker.Telnyx.OpenApiClient.Models.UpdateSubNumberOrderRequirementGroupRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Telnyx.OpenApiClient.Models.UpdateSubNumberOrderRequirementGroupRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Telnyx.OpenApiClient.Models.UpdateSubNumberOrderRequirementGroupRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
