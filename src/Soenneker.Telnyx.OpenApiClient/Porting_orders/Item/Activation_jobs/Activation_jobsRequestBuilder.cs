...
namespace Soenneker.Telnyx.OpenApiClient.Porting_orders.Item.Activation_jobs
{
    ...
    public partial class Activation_jobsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Activation_jobsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/porting_orders/{%2Did}/activation_jobs{?page*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Porting_orders.Item.Activation_jobs.Activation_jobsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Activation_jobsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/porting_orders/{%2Did}/activation_jobs{?page*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.ListPortingOrderActivationJobs200Response?> GetAsync(Action<RequestConfiguration<global::Soenneker.Telnyx.OpenApiClient.Porting_orders.Item.Activation_jobs.Activation_jobsRequestBuilder.Activation_jobsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.ListPortingOrderActivationJobs200Response> GetAsync(Action<RequestConfiguration<global::Soenneker.Telnyx.OpenApiClient.Porting_orders.Item.Activation_jobs.Activation_jobsRequestBuilder.Activation_jobsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.OpenApiClient.Models.ListPortingOrderActivationJobs200Response>(requestInfo, global::Soenneker.Telnyx.OpenApiClient.Models.ListPortingOrderActivationJobs200Response.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns a list of your porting activation jobs.
        /// </summary>
