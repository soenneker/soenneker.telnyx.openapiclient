...
using Soenneker.Telnyx.OpenApiClient.OneZerodlc.Brand.Feedback;
using Soenneker.Telnyx.OpenApiClient.OneZerodlc.Brand.Item;
using Soenneker.Telnyx.OpenApiClient.OneZerodlc.Brand.SmsOtp;
...
{
    /// <summary>
    /// Builds and executes requests for operations under \10dlc\brand
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class BrandRequestBuilder : BaseRequestBuilder
    {
        /// <summary>The feedback property</summary>
        public global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Brand.Feedback.FeedbackRequestBuilder Feedback
        {
            get => new global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Brand.Feedback.FeedbackRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The smsOtp property</summary>
        public global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Brand.SmsOtp.SmsOtpRequestBuilder SmsOtp
        {
        ...
        public global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Brand.Item.WithBrandItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Brand.Item.WithBrandItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Brand.BrandRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BrandRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/10dlc/brand{?brandId*,country*,displayName*,entityType*,page*,recordsPerPage*,sort*,state*,tcrBrandId*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Brand.BrandRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BrandRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/10dlc/brand{?brandId*,country*,displayName*,entityType*,page*,recordsPerPage*,sort*,state*,tcrBrandId*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Brand.BrandRequestBuilder.BrandRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Brand.BrandRequestBuilder.BrandRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Brand.BrandRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Brand.BrandRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Brand.BrandRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// This endpoint is used to list all brands associated with your organization.
        /// </summary>
