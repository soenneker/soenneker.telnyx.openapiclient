...
using Soenneker.Telnyx.OpenApiClient.OneZerodlc.Partner_campaigns.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Telnyx.OpenApiClient.OneZerodlc.Partner_campaigns
{
    /// <summary>
    /// Builds and executes requests for operations under \10dlc\partner_campaigns
    /// </summary>
    ...
    public partial class Partner_campaignsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Partner_campaigns.Item.WithCampaignItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Partner_campaigns.Item.WithCampaignItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Partner_campaigns.Partner_campaignsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Partner_campaignsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/10dlc/partner_campaigns{?page*,recordsPerPage*,sort*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Partner_campaigns.Partner_campaignsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Partner_campaignsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/10dlc/partner_campaigns{?page*,recordsPerPage*,sort*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Partner_campaigns.Partner_campaignsRequestBuilder.Partner_campaignsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Partner_campaigns.Partner_campaignsRequestBuilder.Partner_campaignsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Partner_campaigns.Partner_campaignsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Partner_campaigns.Partner_campaignsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.Partner_campaigns.Partner_campaignsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve all partner campaigns you have shared to Telnyx in a paginated fashion.This endpoint is currently limited to only returning shared campaigns that Telnyx has accepted. In other words, shared but pending campaigns are currently omitted from the response from this endpoint.
        /// </summary>
