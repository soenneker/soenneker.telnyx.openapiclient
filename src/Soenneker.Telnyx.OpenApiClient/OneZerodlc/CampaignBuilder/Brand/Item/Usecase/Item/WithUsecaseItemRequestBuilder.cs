...
using System;
namespace Soenneker.Telnyx.OpenApiClient.OneZerodlc.CampaignBuilder.Brand.Item.Usecase.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \10dlc\campaignBuilder\brand\{brandId}\usecase\{usecase}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithUsecaseItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.CampaignBuilder.Brand.Item.Usecase.Item.WithUsecaseItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithUsecaseItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/10dlc/campaignBuilder/brand/{brandId}/usecase/{usecase}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.CampaignBuilder.Brand.Item.Usecase.Item.WithUsecaseItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithUsecaseItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/10dlc/campaignBuilder/brand/{brandId}/usecase/{usecase}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.CampaignBuilder.Brand.Item.Usecase.Item.WithUsecaseItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Telnyx.OpenApiClient.OneZerodlc.CampaignBuilder.Brand.Item.Usecase.Item.WithUsecaseItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
