...
{
    /// <summary>
    /// Builds and executes requests for operations under \texml\Accounts\{accountSid}\Transcriptions.json
    /// </summary>
    ...
    public partial class TranscriptionsJsonRequestBuilder : BaseRequestBuilder
    {
        ...
        public TranscriptionsJsonRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/texml/Accounts/{accountSid}/Transcriptions.json{?PageSize*,PageToken*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Texml.Accounts.Item.TranscriptionsJson.TranscriptionsJsonRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TranscriptionsJsonRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/texml/Accounts/{accountSid}/Transcriptions.json{?PageSize*,PageToken*}", rawUrl)
        {
        }
        /// <summary>
        /// Returns multiple recording transcription resources for an account.
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.ListRecordingTranscriptionsResponse"/></returns>
...
#nullable restore
        ...
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.ListRecordingTranscriptionsResponse> GetAsync(Action<RequestConfiguration<global::Soenneker.Telnyx.OpenApiClient.Texml.Accounts.Item.TranscriptionsJson.TranscriptionsJsonRequestBuilder.TranscriptionsJsonRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.OpenApiClient.Models.ListRecordingTranscriptionsResponse>(requestInfo, global::Soenneker.Telnyx.OpenApiClient.Models.ListRecordingTranscriptionsResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns multiple recording transcription resources for an account.
        /// </summary>
