...
{
    /// <summary>
    /// Builds and executes requests for operations under \ai\assistants\tests\test-suites\{suiteName}\runs
    /// </summary>
    ...
    public partial class RunsRequestBuilder : BaseRequestBuilder
    {
        ...
        public RunsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/ai/assistants/tests/test-suites/{suiteName}/runs{?page*,status*,test_suite_run_id*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Ai.Assistants.Tests.TestSuites.Item.Runs.RunsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RunsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/ai/assistants/tests/test-suites/{suiteName}/runs{?page*,status*,test_suite_run_id*}", rawUrl)
        {
        }
        /// <summary>
