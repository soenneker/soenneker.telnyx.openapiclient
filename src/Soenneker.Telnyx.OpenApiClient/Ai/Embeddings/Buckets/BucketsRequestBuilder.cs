...
namespace Soenneker.Telnyx.OpenApiClient.Ai.Embeddings.Buckets
{
    ...
    public partial class BucketsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="position">Name of the bucket.</param>
        ...
        public global::Soenneker.Telnyx.OpenApiClient.Ai.Embeddings.Buckets.Item.WithBucketNameItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("bucketName", position);
                return new global::Soenneker.Telnyx.OpenApiClient.Ai.Embeddings.Buckets.Item.WithBucketNameItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        ...
        public BucketsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/ai/embeddings/buckets", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Ai.Embeddings.Buckets.BucketsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BucketsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/ai/embeddings/buckets", rawUrl)
        {
        }
        /// <summary>
