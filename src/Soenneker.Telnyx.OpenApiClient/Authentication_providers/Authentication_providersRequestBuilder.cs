...
namespace Soenneker.Telnyx.OpenApiClient.Authentication_providers
{
    ...
    public partial class Authentication_providersRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.FindAuthenticationProviders200"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.Telnyx.OpenApiClient.Authentication_providers.FindAuthenticationProviders200400Error">When receiving a 400 status code</exception>
        /// <exception cref="global::Soenneker.Telnyx.OpenApiClient.Authentication_providers.FindAuthenticationProviders200401Error">When receiving a 401 status code</exception>
        /// <exception cref="global::Soenneker.Telnyx.OpenApiClient.Authentication_providers.FindAuthenticationProviders200404Error">When receiving a 404 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.FindAuthenticationProviders200?> GetAsync(Action<RequestConfiguration<global::Soenneker.Telnyx.OpenApiClient.Authentication_providers.Authentication_providersRequestBuilder.Authentication_providersRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.FindAuthenticationProviders200> GetAsync(Action<RequestConfiguration<global::Soenneker.Telnyx.OpenApiClient.Authentication_providers.Authentication_providersRequestBuilder.Authentication_providersRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "400", global::Soenneker.Telnyx.OpenApiClient.Authentication_providers.FindAuthenticationProviders200400Error.CreateFromDiscriminatorValue },
                { "401", global::Soenneker.Telnyx.OpenApiClient.Authentication_providers.FindAuthenticationProviders200401Error.CreateFromDiscriminatorValue },
                { "404", global::Soenneker.Telnyx.OpenApiClient.Authentication_providers.FindAuthenticationProviders200404Error.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.OpenApiClient.Models.FindAuthenticationProviders200>(requestInfo, global::Soenneker.Telnyx.OpenApiClient.Models.FindAuthenticationProviders200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
