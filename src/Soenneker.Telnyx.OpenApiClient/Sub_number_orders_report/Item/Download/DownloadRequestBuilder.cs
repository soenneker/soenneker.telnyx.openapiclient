...
{
    /// <summary>
    /// Builds and executes requests for operations under \sub_number_orders_report\{reportId}\download
    /// </summary>
    ...
    public partial class DownloadRequestBuilder : BaseRequestBuilder
    {
        ...
        public DownloadRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sub_number_orders_report/{reportId}/download", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Sub_number_orders_report.Item.Download.DownloadRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DownloadRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/sub_number_orders_report/{reportId}/download", rawUrl)
        {
        }
        /// <summary>
