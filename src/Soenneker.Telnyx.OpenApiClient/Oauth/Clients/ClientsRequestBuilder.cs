...
using Soenneker.Telnyx.OpenApiClient.Oauth.Clients.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Telnyx.OpenApiClient.Oauth.Clients
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the Soenneker.Telnyx.OpenApiClient.oauth.clients.item collection</summary>
        ...
        public global::Soenneker.Telnyx.OpenApiClient.Oauth.Clients.Item.ClientsItemRequestBuilder this[Guid position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("id", position);
                return new global::Soenneker.Telnyx.OpenApiClient.Oauth.Clients.Item.ClientsItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Oauth.Clients.ClientsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ClientsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/oauth/clients{?filter%5Ballowed_grant_types%5D%5Bcontains%5D*,filter%5Bclient_id%5D*,filter%5Bclient_type%5D*,filter%5Bname%5D*,filter%5Bname%5D%5Bcontains%5D*,filter%5Bverified%5D*,page%5Bnumber%5D*,page%5Bsize%5D*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Oauth.Clients.ClientsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ClientsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/oauth/clients{?filter%5Ballowed_grant_types%5D%5Bcontains%5D*,filter%5Bclient_id%5D*,filter%5Bclient_type%5D*,filter%5Bname%5D*,filter%5Bname%5D%5Bcontains%5D*,filter%5Bverified%5D*,page%5Bnumber%5D*,page%5Bsize%5D*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Telnyx.OpenApiClient.Oauth.Clients.ClientsRequestBuilder.ClientsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Telnyx.OpenApiClient.Oauth.Clients.ClientsRequestBuilder.ClientsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Oauth.Clients.ClientsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Telnyx.OpenApiClient.Oauth.Clients.ClientsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Telnyx.OpenApiClient.Oauth.Clients.ClientsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve a paginated list of OAuth clients for the authenticated user
        /// </summary>
