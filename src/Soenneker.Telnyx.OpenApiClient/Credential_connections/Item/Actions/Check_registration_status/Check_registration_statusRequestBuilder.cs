...
namespace Soenneker.Telnyx.OpenApiClient.Credential_connections.Item.Actions.Check_registration_status
{
    ...
    public partial class Check_registration_statusRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.RegistrationStatusResponse"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.RegistrationStatusResponse?> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.RegistrationStatusResponse> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.OpenApiClient.Models.RegistrationStatusResponse>(requestInfo, global::Soenneker.Telnyx.OpenApiClient.Models.RegistrationStatusResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Checks the registration_status for a credential connection, (`registration_status`) as well as the timestamp for the last SIP registration event (`registration_status_updated_at`)
        /// </summary>
