...
namespace Soenneker.Telnyx.OpenApiClient.Models
{
    ...
    public partial class NumberOrderWebhookPayload : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Telnyx.OpenApiClient.Models.NumberOrderWebhookPhoneNumber>? PhoneNumbers { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Telnyx.OpenApiClient.Models.NumberOrderWebhookPhoneNumber> PhoneNumbers { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.Telnyx.OpenApiClient.Models.NumberOrderWebhookPayloadStatus? Status { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.NumberOrderWebhookPayload"/> and sets the default values.
        /// </summary>
        public NumberOrderWebhookPayload()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.NumberOrderWebhookPayload"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.OpenApiClient.Models.NumberOrderWebhookPayload CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.OpenApiClient.Models.NumberOrderWebhookPayload();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "phone_numbers", n => { PhoneNumbers = n.GetCollectionOfObjectValues<global::Soenneker.Telnyx.OpenApiClient.Models.NumberOrderWebhookPhoneNumber>(global::Soenneker.Telnyx.OpenApiClient.Models.NumberOrderWebhookPhoneNumber.CreateFromDiscriminatorValue)?.AsList(); } },
                { "phone_numbers_count", n => { PhoneNumbersCount = n.GetIntValue(); } },
                { "record_type", n => { RecordType = n.GetStringValue(); } },
                { "requirements_met", n => { RequirementsMet = n.GetBoolValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.NumberOrderWebhookPayloadStatus>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Telnyx.OpenApiClient.Models.NumberOrderWebhookPhoneNumber>("phone_numbers", PhoneNumbers);
            ...
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.NumberOrderWebhookPayloadStatus>("status", Status);
