...
namespace Soenneker.Telnyx.OpenApiClient.Models
{
    ...
    public partial class NumbersSubNumberOrder : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// <summary>The first 50 phone numbers in the sub number order, including their per-number regulatory requirement statuses. Only present when filter[include_phone_numbers]=true is used.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Telnyx.OpenApiClient.Models.NumbersSubNumberOrderPhoneNumber>? PhoneNumbers { get; private set; }
#nullable restore
#else
        public List<global::Soenneker.Telnyx.OpenApiClient.Models.NumbersSubNumberOrderPhoneNumber> PhoneNumbers { get; private set; }
#endif
        ...
        public global::Soenneker.Telnyx.OpenApiClient.Models.NumbersSubNumberOrderPhoneNumberType? PhoneNumberType { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Telnyx.OpenApiClient.Models.NumbersSubNumberOrderStatus? Status { get; private set; }
        /// <summary>An ISO 8901 datetime string for when the number order was updated.</summary>
        public DateTimeOffset? UpdatedAt { get; private set; }
        /// <summary>The user_id property</summary>
        public Guid? UserId { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.NumbersSubNumberOrder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.NumbersSubNumberOrder"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.OpenApiClient.Models.NumbersSubNumberOrder CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.OpenApiClient.Models.NumbersSubNumberOrder();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "phone_number_type", n => { PhoneNumberType = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.NumbersSubNumberOrderPhoneNumberType>(); } },
                { "phone_numbers", n => { PhoneNumbers = n.GetCollectionOfObjectValues<global::Soenneker.Telnyx.OpenApiClient.Models.NumbersSubNumberOrderPhoneNumber>(global::Soenneker.Telnyx.OpenApiClient.Models.NumbersSubNumberOrderPhoneNumber.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.NumbersSubNumberOrderStatus>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.NumbersSubNumberOrderPhoneNumberType>("phone_number_type", PhoneNumberType);
