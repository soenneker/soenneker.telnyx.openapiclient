...
namespace Soenneker.Telnyx.OpenApiClient.Models
{
    ...
    public partial class CreateVerifyProfileRCSRequest : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// <summary>Enable SMS fallback when RCS delivery fails.</summary>
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.CreateVerifyProfileRCSRequest"/> and sets the default values.
        /// </summary>
        public CreateVerifyProfileRCSRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.CreateVerifyProfileRCSRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.OpenApiClient.Models.CreateVerifyProfileRCSRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.OpenApiClient.Models.CreateVerifyProfileRCSRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "sms_fallback", n => { SmsFallback = n.GetBoolValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteBoolValue("sms_fallback", SmsFallback);
