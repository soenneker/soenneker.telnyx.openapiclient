...
{
    /// <summary>
    /// A standalone scripted-message step in a flow, as supplied by clients.Unlike a prompt node, a speak node has no instructions or model — it isn&apos;tan LLM turn. Reaching it delivers `message` to the user verbatim (with`{{variable}}` interpolation), then routes via outgoing `llm` /`expression` edges.
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class SpeakNodeReq : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.SpeakNodeReq"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.OpenApiClient.Models.SpeakNodeReq CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.OpenApiClient.Models.SpeakNodeReq();
        }
        /// <summary>
