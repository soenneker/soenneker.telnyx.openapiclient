...
namespace Soenneker.Telnyx.OpenApiClient.Models
{
    ...
    public partial class InitiateAICallRequest : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Key-value map of dynamic variables to pass to the AI assistant.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_AIAssistantDynamicVariables? AIAssistantDynamicVariables { get; set; }
#nullable restore
#else
        public global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_AIAssistantDynamicVariables AIAssistantDynamicVariables { get; set; }
#endif
        /// <summary>The ID of the AI assistant to use for the call.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string AIAssistantId { get; set; }
#endif
        /// <summary>The version of the AI assistant to use.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? AIAssistantVersion { get; set; }
#nullable restore
#else
        public string AIAssistantVersion { get; set; }
#endif
...
#nullable restore
        ...
        public string AsyncAmdStatusCallback { get; set; }
#endif
        /// <summary>HTTP request type used for `AsyncAmdStatusCallback`.</summary>
        public global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_AsyncAmdStatusCallbackMethod? AsyncAmdStatusCallbackMethod { get; set; }
        /// <summary>To be used as the caller id name (SIP From Display Name) presented to the destination (`To` number). The string should have a maximum of 128 characters, containing only letters, numbers, spaces, and `-_~!.+` special characters. If omitted, the display name will be the same as the number in the `From` field.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// <summary>A string of passport identifiers to associate with the call.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_RecordingChannels? RecordingChannels { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_RecordingStatusCallbackMethod? RecordingStatusCallbackMethod { get; set; }
        /// <summary>The number of seconds that Telnyx will wait for the recording to be stopped if silence is detected. The timer only starts when the speech is detected. The minimum value is 0. The default value is 0 (infinite).</summary>
        public int? RecordingTimeout { get; set; }
        /// <summary>The audio track to record for the call. The default is `both`.</summary>
        public global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_RecordingTrack? RecordingTrack { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_Trim? Trim { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest"/> and sets the default values.
        /// </summary>
        public InitiateAICallRequest()
        {
            AdditionalData = new Dictionary<string, object>();
            AsyncAmdStatusCallbackMethod = global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_AsyncAmdStatusCallbackMethod.POST;
            ConversationCallbackMethod = global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_ConversationCallbackMethod.POST;
            DetectionMode = global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_DetectionMode.Regular;
            MachineDetection = global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_MachineDetection.Disable;
            SipRegion = global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_SipRegion.US;
            StatusCallbackEvent = "completed";
            StatusCallbackMethod = global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_StatusCallbackMethod.POST;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "AIAssistantDynamicVariables", n => { AIAssistantDynamicVariables = n.GetObjectValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_AIAssistantDynamicVariables>(global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_AIAssistantDynamicVariables.CreateFromDiscriminatorValue); } },
                { "AIAssistantId", n => { AIAssistantId = n.GetStringValue(); } },
                { "AIAssistantVersion", n => { AIAssistantVersion = n.GetStringValue(); } },
                { "AsyncAmd", n => { AsyncAmd = n.GetBoolValue(); } },
                { "AsyncAmdStatusCallback", n => { AsyncAmdStatusCallback = n.GetStringValue(); } },
                { "AsyncAmdStatusCallbackMethod", n => { AsyncAmdStatusCallbackMethod = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_AsyncAmdStatusCallbackMethod>(); } },
                { "CallerId", n => { CallerId = n.GetStringValue(); } },
                { "ConversationCallback", n => { ConversationCallback = n.GetStringValue(); } },
                { "ConversationCallbackMethod", n => { ConversationCallbackMethod = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_ConversationCallbackMethod>(); } },
                { "ConversationCallbacks", n => { ConversationCallbacks = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "CustomHeaders", n => { CustomHeaders = n.GetCollectionOfObjectValues<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_CustomHeaders>(global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_CustomHeaders.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "RecordingChannels", n => { RecordingChannels = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_RecordingChannels>(); } },
                ...
                { "RecordingStatusCallbackMethod", n => { RecordingStatusCallbackMethod = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_RecordingStatusCallbackMethod>(); } },
                { "RecordingTimeout", n => { RecordingTimeout = n.GetIntValue(); } },
                { "RecordingTrack", n => { RecordingTrack = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_RecordingTrack>(); } },
                ...
                { "SipRegion", n => { SipRegion = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_SipRegion>(); } },
                { "StatusCallback", n => { StatusCallback = n.GetStringValue(); } },
                { "StatusCallbackEvent", n => { StatusCallbackEvent = n.GetStringValue(); } },
                { "StatusCallbackMethod", n => { StatusCallbackMethod = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_StatusCallbackMethod>(); } },
                { "StatusCallbacks", n => { StatusCallbacks = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "TimeLimit", n => { TimeLimit = n.GetIntValue(); } },
                { "Timeout", n => { Timeout = n.GetIntValue(); } },
                { "To", n => { To = n.GetStringValue(); } },
                { "Trim", n => { Trim = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_Trim>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_AIAssistantDynamicVariables>("AIAssistantDynamicVariables", AIAssistantDynamicVariables);
            writer.WriteStringValue("AIAssistantId", AIAssistantId);
            writer.WriteStringValue("AIAssistantVersion", AIAssistantVersion);
            writer.WriteBoolValue("AsyncAmd", AsyncAmd);
            writer.WriteStringValue("AsyncAmdStatusCallback", AsyncAmdStatusCallback);
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_AsyncAmdStatusCallbackMethod>("AsyncAmdStatusCallbackMethod", AsyncAmdStatusCallbackMethod);
            writer.WriteStringValue("CallerId", CallerId);
            writer.WriteStringValue("ConversationCallback", ConversationCallback);
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_ConversationCallbackMethod>("ConversationCallbackMethod", ConversationCallbackMethod);
            writer.WriteCollectionOfPrimitiveValues<string>("ConversationCallbacks", ConversationCallbacks);
            writer.WriteCollectionOfObjectValues<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_CustomHeaders>("CustomHeaders", CustomHeaders);
            ...
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_RecordingChannels>("RecordingChannels", RecordingChannels);
            ...
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_RecordingStatusCallbackMethod>("RecordingStatusCallbackMethod", RecordingStatusCallbackMethod);
            writer.WriteIntValue("RecordingTimeout", RecordingTimeout);
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_RecordingTrack>("RecordingTrack", RecordingTrack);
            ...
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_SipRegion>("SipRegion", SipRegion);
            writer.WriteStringValue("StatusCallback", StatusCallback);
            writer.WriteStringValue("StatusCallbackEvent", StatusCallbackEvent);
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_StatusCallbackMethod>("StatusCallbackMethod", StatusCallbackMethod);
            writer.WriteCollectionOfPrimitiveValues<string>("StatusCallbacks", StatusCallbacks);
            writer.WriteIntValue("TimeLimit", TimeLimit);
            writer.WriteIntValue("Timeout", Timeout);
            writer.WriteStringValue("To", To);
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.InitiateAICallRequest_Trim>("Trim", Trim);
