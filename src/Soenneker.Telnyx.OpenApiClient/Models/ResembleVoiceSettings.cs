...
namespace Soenneker.Telnyx.OpenApiClient.Models
{
    ...
    public partial class ResembleVoiceSettings : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Output audio format.</summary>
        public global::Soenneker.Telnyx.OpenApiClient.Models.ResembleVoiceSettingsFormat? Format { get; set; }
        /// <summary>Audio precision format.</summary>
        public global::Soenneker.Telnyx.OpenApiClient.Models.ResembleVoiceSettingsPrecision? Precision { get; set; }
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.ResembleVoiceSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.OpenApiClient.Models.ResembleVoiceSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.OpenApiClient.Models.ResembleVoiceSettings();
        }
        /// <summary>
