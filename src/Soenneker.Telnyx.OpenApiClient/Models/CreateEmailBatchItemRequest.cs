...
{
    /// <summary>
    /// A single message in a batch create request. This schema mirrors`CreateEmailRequest` EXCEPT it does not accept the reply/forwardthreading parameters (`in_reply_to_message_id`, `reply_to_all`,`forward_of_message_id`) — those are single-send-only in Phase 1(MSG-1491) and are not yet implemented on the batch endpoint. Recipientemail addresses must be unique across `to`, `cc`, and `bcc` aftercase-insensitive normalization. Duplicate recipients return `400`.
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class CreateEmailBatchItemRequest : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Telnyx.OpenApiClient.Models.CreateEmailBatchItemRequestHeadersProperty? Headers { get; set; }
#nullable restore
#else
        public global::Soenneker.Telnyx.OpenApiClient.Models.CreateEmailBatchItemRequestHeadersProperty Headers { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.CreateEmailBatchItemRequest"/> and sets the default values.
        /// </summary>
        public CreateEmailBatchItemRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.CreateEmailBatchItemRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.OpenApiClient.Models.CreateEmailBatchItemRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.OpenApiClient.Models.CreateEmailBatchItemRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "headers", n => { Headers = n.GetObjectValue<global::Soenneker.Telnyx.OpenApiClient.Models.CreateEmailBatchItemRequestHeadersProperty>(global::Soenneker.Telnyx.OpenApiClient.Models.CreateEmailBatchItemRequestHeadersProperty.CreateFromDiscriminatorValue); } },
                ...
                { "metadata", n => { Metadata = n.GetObjectValue<global::Soenneker.Telnyx.OpenApiClient.Models.CreateEmailBatchItemRequestMetadataProperty>(global::Soenneker.Telnyx.OpenApiClient.Models.CreateEmailBatchItemRequestMetadataProperty.CreateFromDiscriminatorValue); } },
                ...
                { "template_variables", n => { TemplateVariables = n.GetObjectValue<global::Soenneker.Telnyx.OpenApiClient.Models.CreateEmailBatchItemRequestTemplateVariablesProperty>(global::Soenneker.Telnyx.OpenApiClient.Models.CreateEmailBatchItemRequestTemplateVariablesProperty.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Telnyx.OpenApiClient.Models.CreateEmailBatchItemRequestHeadersProperty>("headers", Headers);
            ...
            writer.WriteObjectValue<global::Soenneker.Telnyx.OpenApiClient.Models.CreateEmailBatchItemRequestMetadataProperty>("metadata", Metadata);
            ...
            writer.WriteObjectValue<global::Soenneker.Telnyx.OpenApiClient.Models.CreateEmailBatchItemRequestTemplateVariablesProperty>("template_variables", TemplateVariables);
