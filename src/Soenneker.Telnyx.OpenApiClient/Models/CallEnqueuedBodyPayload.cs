...
namespace Soenneker.Telnyx.OpenApiClient.Models
{
    ...
    public partial class CallEnqueuedBodyPayload : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public string Queue { get; set; }
#endif
        /// <summary>Average time call spends in the queue in seconds.</summary>
        public int? QueueAvgWaitTimeSecs { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.CallEnqueuedBodyPayload"/> and sets the default values.
        /// </summary>
        public CallEnqueuedBodyPayload()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.CallEnqueuedBodyPayload"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.OpenApiClient.Models.CallEnqueuedBodyPayload CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.OpenApiClient.Models.CallEnqueuedBodyPayload();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "current_position", n => { CurrentPosition = n.GetIntValue(); } },
                { "queue", n => { Queue = n.GetStringValue(); } },
                { "queue_avg_wait_time_secs", n => { QueueAvgWaitTimeSecs = n.GetIntValue(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteIntValue("current_position", CurrentPosition);
            writer.WriteStringValue("queue", Queue);
            writer.WriteIntValue("queue_avg_wait_time_secs", QueueAvgWaitTimeSecs);
