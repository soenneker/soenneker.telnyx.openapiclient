...
namespace Soenneker.Telnyx.OpenApiClient.Models
{
    ...
    public partial class UpdateVerifyProfileSettingsWhatsAppRequest : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// <summary>Phone number registered on the customer WABA to send OTPs from</summary>
...
#nullable restore
        ...
        public string TemplateId { get; set; }
#endif
        /// <summary>Customer Meta WABA ID for Bring-Your-Own-WABA sending</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.UpdateVerifyProfileSettingsWhatsAppRequest"/> and sets the default values.
        /// </summary>
        public UpdateVerifyProfileSettingsWhatsAppRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.UpdateVerifyProfileSettingsWhatsAppRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.OpenApiClient.Models.UpdateVerifyProfileSettingsWhatsAppRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.OpenApiClient.Models.UpdateVerifyProfileSettingsWhatsAppRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "sender_phone_number", n => { SenderPhoneNumber = n.GetStringValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteStringValue("sender_phone_number", SenderPhoneNumber);
