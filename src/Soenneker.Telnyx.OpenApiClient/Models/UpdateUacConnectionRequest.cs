...
{
    /// <summary>
    /// Parameters that can be updated in a UAC connection. A UAC (User Agent Client) Connection registers Telnyx to your PBX — the opposite of a standard SIP trunk, where the PBX registers to Telnyx. Use UAC when your PBX doesn’t support outbound SIP registration or you need Telnyx to maintain the registration.
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class UpdateUacConnectionRequest : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        /// <summary>External SIP peer settings used by Telnyx when registering to your PBX and routing outbound calls.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Telnyx.OpenApiClient.Models.UacExternalSettings? ExternalUacSettings { get; set; }
#nullable restore
#else
        public global::Soenneker.Telnyx.OpenApiClient.Models.UacExternalSettings ExternalUacSettings { get; set; }
#endif
        /// <summary>Inbound settings that can be supplied when creating or updating a UAC connection. The SIP subdomain fields returned in UAC connection responses are generated by Telnyx and are not accepted as request parameters.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Telnyx.OpenApiClient.Models.UacInboundRequest? Inbound { get; set; }
#nullable restore
#else
        public global::Soenneker.Telnyx.OpenApiClient.Models.UacInboundRequest Inbound { get; set; }
#endif
        /// <summary>Internal Telnyx-side settings for a UAC connection.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Telnyx.OpenApiClient.Models.UacInternalSettings? InternalUacSettings { get; set; }
#nullable restore
#else
        public global::Soenneker.Telnyx.OpenApiClient.Models.UacInternalSettings InternalUacSettings { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.Telnyx.OpenApiClient.Models.UpdateUacConnectionRequest_sip_uri_calling_preference? SipUriCallingPreference { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Telnyx.OpenApiClient.Models.UpdateUacConnectionRequest_webhook_api_version? WebhookApiVersion { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.UpdateUacConnectionRequest"/> and sets the default values.
        /// </summary>
        public UpdateUacConnectionRequest()
        {
            ...
            WebhookApiVersion = global::Soenneker.Telnyx.OpenApiClient.Models.UpdateUacConnectionRequest_webhook_api_version.One;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.UpdateUacConnectionRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.OpenApiClient.Models.UpdateUacConnectionRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.OpenApiClient.Models.UpdateUacConnectionRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "inbound", n => { Inbound = n.GetObjectValue<global::Soenneker.Telnyx.OpenApiClient.Models.UacInboundRequest>(global::Soenneker.Telnyx.OpenApiClient.Models.UacInboundRequest.CreateFromDiscriminatorValue); } },
                { "internal_uac_settings", n => { InternalUacSettings = n.GetObjectValue<global::Soenneker.Telnyx.OpenApiClient.Models.UacInternalSettings>(global::Soenneker.Telnyx.OpenApiClient.Models.UacInternalSettings.CreateFromDiscriminatorValue); } },
                ...
                { "outbound", n => { Outbound = n.GetObjectValue<global::Soenneker.Telnyx.OpenApiClient.Models.UacOutbound>(global::Soenneker.Telnyx.OpenApiClient.Models.UacOutbound.CreateFromDiscriminatorValue); } },
                ...
                { "sip_uri_calling_preference", n => { SipUriCallingPreference = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.UpdateUacConnectionRequest_sip_uri_calling_preference>(); } },
                { "tags", n => { Tags = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "user_name", n => { UserName = n.GetStringValue(); } },
                { "webhook_api_version", n => { WebhookApiVersion = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.UpdateUacConnectionRequest_webhook_api_version>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Telnyx.OpenApiClient.Models.UacInboundRequest>("inbound", Inbound);
            writer.WriteObjectValue<global::Soenneker.Telnyx.OpenApiClient.Models.UacInternalSettings>("internal_uac_settings", InternalUacSettings);
            ...
            writer.WriteObjectValue<global::Soenneker.Telnyx.OpenApiClient.Models.UacOutbound>("outbound", Outbound);
            ...
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.UpdateUacConnectionRequest_sip_uri_calling_preference>("sip_uri_calling_preference", SipUriCallingPreference);
            writer.WriteCollectionOfPrimitiveValues<string>("tags", Tags);
            writer.WriteStringValue("user_name", UserName);
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.UpdateUacConnectionRequest_webhook_api_version>("webhook_api_version", WebhookApiVersion);
