...
namespace Soenneker.Telnyx.OpenApiClient.Models
{
    ...
    public partial class DirUpdateRequest : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Contact email of the authorizer. Telnyx may send verification or infringement notices here.</summary>
...
#nullable restore
        ...
        public string AuthorizerEmail { get; set; }
#endif
        /// <summary>Name of the person at your enterprise authorizing this DIR. Must be a real individual.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public List<string> CallReasons { get; set; }
#endif
        /// <summary>Certification that the DIR information is accurate. Must be `true` for the DIR to be submitted for vetting.</summary>
        public bool? CertifyBrandIsAccurate { get; set; }
        /// <summary>Certification of ownership of any logos/trademarks shown. Must be `true` for the DIR to be submitted for vetting.</summary>
        public bool? CertifyIpOwnership { get; set; }
        /// <summary>Certification that this DIR is not used for SHAFT content (Sex, Hate, Alcohol, Firearms, Tobacco) where prohibited. Must be `true` for the DIR to be submitted for vetting.</summary>
        public bool? CertifyNoShaftContent { get; set; }
        /// <summary>Name shown to call recipients. 1–35 characters, no emoji, not whitespace-only.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.DirUpdateRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.OpenApiClient.Models.DirUpdateRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.OpenApiClient.Models.DirUpdateRequest();
        }
        /// <summary>
