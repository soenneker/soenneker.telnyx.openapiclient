...
namespace Soenneker.Telnyx.OpenApiClient.Models
{
    ...
    public partial class MobilePhoneNumberUpdateCallRecording : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        public MobilePhoneNumberUpdateCallRecording()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.MobilePhoneNumberUpdateCallRecording"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.OpenApiClient.Models.MobilePhoneNumberUpdateCallRecording CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.OpenApiClient.Models.MobilePhoneNumberUpdateCallRecording();
        }
        /// <summary>
