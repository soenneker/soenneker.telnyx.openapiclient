...
namespace Soenneker.Telnyx.OpenApiClient.Models
{
    ...
    public partial class CreateLongCodeMessageRequest : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::Soenneker.Telnyx.OpenApiClient.Models.CreateLongCodeMessageRequestEncoding? Encoding { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Telnyx.OpenApiClient.Models.CreateLongCodeMessageRequestType? Type { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.CreateLongCodeMessageRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.CreateLongCodeMessageRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.OpenApiClient.Models.CreateLongCodeMessageRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.OpenApiClient.Models.CreateLongCodeMessageRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "encoding", n => { Encoding = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.CreateLongCodeMessageRequestEncoding>(); } },
                { "from", n => { From = n.GetStringValue(); } },
                { "media_urls", n => { MediaUrls = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "subject", n => { Subject = n.GetStringValue(); } },
                { "text", n => { Text = n.GetStringValue(); } },
                { "to", n => { To = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.CreateLongCodeMessageRequestType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.CreateLongCodeMessageRequestEncoding>("encoding", Encoding);
            writer.WriteStringValue("from", From);
            writer.WriteCollectionOfPrimitiveValues<string>("media_urls", MediaUrls);
            writer.WriteStringValue("subject", Subject);
            writer.WriteStringValue("text", Text);
            writer.WriteStringValue("to", To);
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.CreateLongCodeMessageRequestType>("type", Type);
