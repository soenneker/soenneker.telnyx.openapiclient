...
namespace Soenneker.Telnyx.OpenApiClient.Models
{
    ...
    public partial class PrivateWirelessGatewayStatus : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>This attribute is an [error code](https://developers.telnyx.com/docs/development/api-fundamentals/api-errors) related to the failure reason.</summary>
