...
namespace Soenneker.Telnyx.OpenApiClient.Models
{
    ...
    public partial class CallReferCompletedBodyPayload : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public string From { get; set; }
#endif
        /// <summary>SIP NOTIFY event status for tracking the REFER attempt.</summary>
        public int? SipNotifyResponse { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.CallReferCompletedBodyPayload"/> and sets the default values.
        /// </summary>
        public CallReferCompletedBodyPayload()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.CallReferCompletedBodyPayload"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.OpenApiClient.Models.CallReferCompletedBodyPayload CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.OpenApiClient.Models.CallReferCompletedBodyPayload();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "sip_notify_response", n => { SipNotifyResponse = n.GetIntValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteIntValue("sip_notify_response", SipNotifyResponse);
