...
#nullable enable
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.RemoveSimCardGroupPrivateWirelessGateway202Response?> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.RemoveSimCardGroupPrivateWirelessGateway202Response> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.OpenApiClient.Models.RemoveSimCardGroupPrivateWirelessGateway202Response>(requestInfo, global::Soenneker.Telnyx.OpenApiClient.Models.RemoveSimCardGroupPrivateWirelessGateway202Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// This action will asynchronously remove an existing Private Wireless Gateway definition from a SIM card group. Completing this operation defines that all SIM cards in the SIM card group will get their traffic handled by Telnyx&apos;s default mobile network configuration.
        /// </summary>
