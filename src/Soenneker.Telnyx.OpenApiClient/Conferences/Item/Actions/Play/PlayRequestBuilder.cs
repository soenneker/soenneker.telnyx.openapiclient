...
{
    /// <summary>
    /// Builds and executes requests for operations under \conferences\{conference-id}\actions\play
    /// </summary>
    ...
    public partial class PlayRequestBuilder : BaseRequestBuilder
    {
        ...
        public PlayRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/conferences/{conference%2Did}/actions/play", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Conferences.Item.Actions.Play.PlayRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PlayRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/conferences/{conference%2Did}/actions/play", rawUrl)
        {
        }
        /// <summary>
        /// Play audio to all or some participants on a conference call.
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.PlayConferenceAudio200Response"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.PlayConferenceAudio200Response?> PostAsync(global::Soenneker.Telnyx.OpenApiClient.Models.ConferencePlayRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.PlayConferenceAudio200Response> PostAsync(global::Soenneker.Telnyx.OpenApiClient.Models.ConferencePlayRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.OpenApiClient.Models.PlayConferenceAudio200Response>(requestInfo, global::Soenneker.Telnyx.OpenApiClient.Models.PlayConferenceAudio200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Play audio to all or some participants on a conference call.
        /// </summary>
