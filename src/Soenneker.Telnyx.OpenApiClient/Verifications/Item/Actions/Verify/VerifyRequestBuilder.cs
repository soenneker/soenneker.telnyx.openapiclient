...
{
    /// <summary>
    /// Builds and executes requests for operations under \verifications\{verificationId}\actions\verify
    /// </summary>
    ...
    public partial class VerifyRequestBuilder : BaseRequestBuilder
    {
        ...
        public VerifyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/verifications/{verificationId}/actions/verify", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Verifications.Item.Actions.Verify.VerifyRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public VerifyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/verifications/{verificationId}/actions/verify", rawUrl)
        {
        }
        /// <summary>
