...
#nullable enable
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.GetMobileNetworkOperators200Response?> GetAsync(Action<RequestConfiguration<global::Soenneker.Telnyx.OpenApiClient.Mobile_network_operators.Mobile_network_operatorsRequestBuilder.Mobile_network_operatorsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.GetMobileNetworkOperators200Response> GetAsync(Action<RequestConfiguration<global::Soenneker.Telnyx.OpenApiClient.Mobile_network_operators.Mobile_network_operatorsRequestBuilder.Mobile_network_operatorsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.OpenApiClient.Models.GetMobileNetworkOperators200Response>(requestInfo, global::Soenneker.Telnyx.OpenApiClient.Models.GetMobileNetworkOperators200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Telnyx has a set of GSM mobile operators partners that are available through our mobile network roaming. This resource is entirely managed by Telnyx and may change over time. That means that this resource won&apos;t allow any write operations for it. Still, it&apos;s available so it can be used as a support resource that can be related to other resources or become a configuration option.
        /// </summary>
