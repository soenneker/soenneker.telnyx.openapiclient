...
namespace Soenneker.Telnyx.OpenApiClient.Conferences.Item.Actions.Record_pause
{
    ...
    public partial class Record_pauseRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Conferences.Item.Actions.Record_pause.Record_pausePostResponse"/></returns>
...
#nullable restore
        ...
        /// Pause conference recording.
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Conferences.Item.Actions.Record_pause.Record_pauseResponse"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.Telnyx.OpenApiClient.Models.ErrorResponse">When receiving a 404 status code</exception>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Conferences.Item.Actions.Record_pause.Record_pauseResponse?> PostAsync(global::Soenneker.Telnyx.OpenApiClient.Models.PauseConferenceRecordingRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Conferences.Item.Actions.Record_pause.Record_pauseResponse> PostAsync(global::Soenneker.Telnyx.OpenApiClient.Models.PauseConferenceRecordingRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
