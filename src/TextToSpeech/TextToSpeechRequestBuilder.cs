...
namespace Soenneker.Telnyx.TextToSpeech
{
    ...
    public partial class TextToSpeechRequestBuilder : BaseRequestBuilder
    {
        ...
        public TextToSpeechRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/text-to-speech", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.TextToSpeech.TextToSpeechRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TextToSpeechRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/text-to-speech", rawUrl)
        {
        }
    }
}
