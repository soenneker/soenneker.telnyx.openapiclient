...
#nullable restore
        ...
        public global::Soenneker.Telnyx.Models.PortingReport_report_type? ReportType { get; set; }
        /// <summary>The current status of the report generation.</summary>
        public global::Soenneker.Telnyx.Models.PortingReport_status? Status { get; set; }
        /// <summary>ISO 8601 formatted date indicating when the resource was updated.</summary>
        public DateTimeOffset? UpdatedAt { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.Models.PortingReport"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.Models.PortingReport"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.Models.PortingReport CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.Models.PortingReport();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "report_type", n => { ReportType = n.GetEnumValue<global::Soenneker.Telnyx.Models.PortingReport_report_type>(); } },
                { "status", n => { Status = n.GetEnumValue<global::Soenneker.Telnyx.Models.PortingReport_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Telnyx.Models.PortingReport_report_type>("report_type", ReportType);
            writer.WriteEnumValue<global::Soenneker.Telnyx.Models.PortingReport_status>("status", Status);
