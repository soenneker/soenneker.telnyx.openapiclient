...
#nullable restore
        ...
        public global::Soenneker.Telnyx.OpenApiClient.Models.CredentialOutbound_ani_override_type? AniOverrideType { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Telnyx.OpenApiClient.Models.CredentialOutbound_t38_reinvite_source? T38ReinviteSource { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.CredentialOutbound"/> and sets the default values.
        /// </summary>
        public CredentialOutbound()
        {
            AdditionalData = new Dictionary<string, object>();
            AniOverrideType = global::Soenneker.Telnyx.OpenApiClient.Models.CredentialOutbound_ani_override_type.Always;
            Localization = "US";
            T38ReinviteSource = global::Soenneker.Telnyx.OpenApiClient.Models.CredentialOutbound_t38_reinvite_source.Telnyx;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.OpenApiClient.Models.CredentialOutbound"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Telnyx.OpenApiClient.Models.CredentialOutbound CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Telnyx.OpenApiClient.Models.CredentialOutbound();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "ani_override_type", n => { AniOverrideType = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.CredentialOutbound_ani_override_type>(); } },
                ...
                { "t38_reinvite_source", n => { T38ReinviteSource = n.GetEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.CredentialOutbound_t38_reinvite_source>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.CredentialOutbound_ani_override_type>("ani_override_type", AniOverrideType);
            ...
            writer.WriteEnumValue<global::Soenneker.Telnyx.OpenApiClient.Models.CredentialOutbound_t38_reinvite_source>("t38_reinvite_source", T38ReinviteSource);
