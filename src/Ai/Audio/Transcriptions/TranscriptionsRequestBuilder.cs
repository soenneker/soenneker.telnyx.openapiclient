...
namespace Soenneker.Telnyx.Ai.Audio.Transcriptions
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.Ai.Audio.Transcriptions.TranscriptionsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Telnyx.Models.AudioTranscriptionResponse?> PostAsync(MultipartBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Telnyx.Models.AudioTranscriptionResponse> PostAsync(MultipartBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.Models.AudioTranscriptionResponse>(requestInfo, global::Soenneker.Telnyx.Models.AudioTranscriptionResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Transcribe speech to text. This endpoint is consistent with the [OpenAI Transcription API](https://platform.openai.com/docs/api-reference/audio/createTranscription) and may be used with the OpenAI JS or Python SDK.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.Ai.Audio.Transcriptions.TranscriptionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Telnyx.Ai.Audio.Transcriptions.TranscriptionsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Telnyx.Ai.Audio.Transcriptions.TranscriptionsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
