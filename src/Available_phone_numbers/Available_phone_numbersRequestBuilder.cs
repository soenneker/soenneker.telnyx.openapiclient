...
namespace Soenneker.Telnyx.Available_phone_numbers
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersGetResponse"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersGetResponse?> GetAsAvailable_phone_numbersGetResponseAsync(Action<RequestConfiguration<global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersRequestBuilder.Available_phone_numbersRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersGetResponse> GetAsAvailable_phone_numbersGetResponseAsync(Action<RequestConfiguration<global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersRequestBuilder.Available_phone_numbersRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersGetResponse>(requestInfo, global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersGetResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// List available phone numbers
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.Telnyx.Models.Errors">When receiving a 4XX or 5XX status code</exception>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersResponse?> GetAsync(Action<RequestConfiguration<global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersRequestBuilder.Available_phone_numbersRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersResponse> GetAsync(Action<RequestConfiguration<global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersRequestBuilder.Available_phone_numbersRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersResponse>(requestInfo, global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// List available phone numbers
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersRequestBuilder.Available_phone_numbersRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersRequestBuilder.Available_phone_numbersRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// List available phone numbers
        /// </summary>
...
#nullable enable
            [QueryParameter("filter%5Bfeatures%5D")]
            public global::Soenneker.Telnyx.Available_phone_numbers.GetFilterFeaturesQueryParameterType[]? FilterfeaturesAsGetFilterFeaturesQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("filter%5Bfeatures%5D")]
            public global::Soenneker.Telnyx.Available_phone_numbers.GetFilterFeaturesQueryParameterType[] FilterfeaturesAsGetFilterFeaturesQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Filter phone numbers by number type.</summary>
            [QueryParameter("filter%5Bphone_number_type%5D")]
            public global::Soenneker.Telnyx.Available_phone_numbers.GetFilterPhone_number_typeQueryParameterType? FilterphoneNumberTypeAsGetFilterPhoneNumberTypeQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Available_phone_numbersRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Telnyx.Available_phone_numbers.Available_phone_numbersRequestBuilder.Available_phone_numbersRequestBuilderGetQueryParameters>
        {
        }
    }
}
