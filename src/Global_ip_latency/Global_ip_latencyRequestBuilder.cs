...
namespace Soenneker.Telnyx.OpenApiClient.Global_ip_latency
{
    ...
    public partial class Global_ip_latencyRequestBuilder : BaseRequestBuilder
    {
        ...
        public Global_ip_latencyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/global_ip_latency{?filter%5Bglobal_ip_id%5D%5Bin%5D*,filter%5Btimestamp%5D%5Bgt%5D*,filter%5Btimestamp%5D%5Blt%5D*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Global_ip_latency.Global_ip_latencyRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Global_ip_latencyRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/global_ip_latency{?filter%5Bglobal_ip_id%5D%5Bin%5D*,filter%5Btimestamp%5D%5Bgt%5D*,filter%5Btimestamp%5D%5Blt%5D*}", rawUrl)
        {
        }
        /// <summary>
