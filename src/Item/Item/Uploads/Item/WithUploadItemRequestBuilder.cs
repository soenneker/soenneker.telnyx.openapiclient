...
namespace Soenneker.Telnyx.OpenApiClient.Item.Item.Uploads.Item
{
    ...
    public partial class WithUploadItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithUploadItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/{bucketName}/{objectName}/uploads/{uploadID}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Item.Item.Uploads.Item.WithUploadItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithUploadItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/{bucketName}/{objectName}/uploads/{uploadID}", rawUrl)
        {
        }
    }
}
