...
using System;
namespace Soenneker.Telnyx.Audit_events
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.Audit_events.Audit_eventsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.Models.AuditLogList"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Telnyx.Models.AuditLogList?> GetAsync(Action<RequestConfiguration<global::Soenneker.Telnyx.Audit_events.Audit_eventsRequestBuilder.Audit_eventsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Telnyx.Models.AuditLogList> GetAsync(Action<RequestConfiguration<global::Soenneker.Telnyx.Audit_events.Audit_eventsRequestBuilder.Audit_eventsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.Models.AuditLogList>(requestInfo, global::Soenneker.Telnyx.Models.AuditLogList.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieve a list of audit log entries. Audit logs are a best-effort, eventually consistent record of significant account-related changes.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Telnyx.Audit_events.Audit_eventsRequestBuilder.Audit_eventsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Telnyx.Audit_events.Audit_eventsRequestBuilder.Audit_eventsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Telnyx.Audit_events.Audit_eventsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Telnyx.Audit_events.Audit_eventsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Telnyx.Audit_events.Audit_eventsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve a list of audit log entries. Audit logs are a best-effort, eventually consistent record of significant account-related changes.
        /// </summary>
...
#nullable restore
            ...
            /// <summary>Specifies the sort order for results. By default sorting direction is ascending. To have the results sorted in descending order add the &lt;code&gt; -&lt;/code&gt; prefix.&lt;br/&gt;&lt;br/&gt;That is: &lt;ul&gt;  &lt;li&gt;    &lt;code&gt;email&lt;/code&gt;: sorts the result by the    &lt;code&gt;email&lt;/code&gt; field in ascending order.  &lt;/li&gt;  &lt;li&gt;    &lt;code&gt;-email&lt;/code&gt;: sorts the result by the    &lt;code&gt;email&lt;/code&gt; field in descending order.  &lt;/li&gt;&lt;/ul&gt; &lt;br/&gt; If not given, results are sorted by &lt;code&gt;created_at&lt;/code&gt; in descending order.</summary>
            [QueryParameter("sort")]
            public global::Soenneker.Telnyx.Audit_events.GetSortQueryParameterType? SortAsGetSortQueryParameterType { get; set; }
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Audit_eventsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Telnyx.Audit_events.Audit_eventsRequestBuilder.Audit_eventsRequestBuilderGetQueryParameters>
        {
        }
    }
}
