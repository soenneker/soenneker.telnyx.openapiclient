...
namespace Soenneker.Telnyx.OpenApiClient.Reports.Wdrs
{
    ...
    public partial class WdrsRequestBuilder : BaseRequestBuilder
    {
        ...
        public WdrsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/wdrs{?end_date*,id*,imsi*,mcc*,mnc*,page*,phone_number*,sim_card_id*,sim_group_id*,sim_group_name*,sort*,start_date*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.Reports.Wdrs.WdrsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WdrsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/reports/wdrs{?end_date*,id*,imsi*,mcc*,mnc*,page*,phone_number*,sim_card_id*,sim_group_id*,sim_group_name*,sort*,start_date*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// <exception cref="global::Soenneker.Telnyx.OpenApiClient.Models.Wireless_public_ErrorResponse">When receiving a 400 status code</exception>
...
#nullable restore
        ...
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Models.ExternalWdrGetDetailResponse> GetAsync(Action<RequestConfiguration<global::Soenneker.Telnyx.OpenApiClient.Reports.Wdrs.WdrsRequestBuilder.WdrsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "400", global::Soenneker.Telnyx.OpenApiClient.Models.Wireless_public_ErrorResponse.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.OpenApiClient.Models.ExternalWdrGetDetailResponse>(requestInfo, global::Soenneker.Telnyx.OpenApiClient.Models.ExternalWdrGetDetailResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Fetch all Wdr records 
        /// </summary>
