...
#nullable restore
        ...
        public async Task<global::Soenneker.Telnyx.Models.ConferenceRecordingResourceIndex> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.Models.ConferenceRecordingResourceIndex>(requestInfo, global::Soenneker.Telnyx.Models.ConferenceRecordingResourceIndex.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Lists conference recordings
        /// </summary>
