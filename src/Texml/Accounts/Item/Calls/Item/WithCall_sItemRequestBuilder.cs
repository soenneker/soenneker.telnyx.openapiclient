...
#nullable restore
        ...
        public async Task<global::Soenneker.Telnyx.Models.CallResource> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.Models.CallResource>(requestInfo, global::Soenneker.Telnyx.Models.CallResource.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
