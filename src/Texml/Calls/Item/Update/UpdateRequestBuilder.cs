...
#nullable enable
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Texml.Calls.Item.Update.UpdatePostResponse?> PostAsync(global::Soenneker.Telnyx.OpenApiClient.Models.UpdateCallRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Telnyx.OpenApiClient.Texml.Calls.Item.Update.UpdatePostResponse> PostAsync(global::Soenneker.Telnyx.OpenApiClient.Models.UpdateCallRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Telnyx.OpenApiClient.Texml.Calls.Item.Update.UpdatePostResponse>(requestInfo, global::Soenneker.Telnyx.OpenApiClient.Texml.Calls.Item.Update.UpdatePostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Update TeXML call. Please note that the keys present in the payload MUST BE formatted in CamelCase as specified in the example.
        /// </summary>
