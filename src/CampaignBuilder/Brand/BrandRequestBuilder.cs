...
namespace Soenneker.Telnyx.OpenApiClient.CampaignBuilder.Brand
{
    ...
    public partial class BrandRequestBuilder : BaseRequestBuilder
    {
        ...
        public BrandRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/campaignBuilder/brand", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.OpenApiClient.CampaignBuilder.Brand.BrandRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BrandRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/campaignBuilder/brand", rawUrl)
        {
        }
    }
}
