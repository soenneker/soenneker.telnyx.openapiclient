...
namespace Soenneker.Telnyx.CampaignBuilder.Brand.Item.Usecase.Item
{
    ...
    public partial class WithUsecaseItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithUsecaseItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/campaignBuilder/brand/{brandId}/usecase/{usecase}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.CampaignBuilder.Brand.Item.Usecase.Item.WithUsecaseItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithUsecaseItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/campaignBuilder/brand/{brandId}/usecase/{usecase}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WithUsecaseItemRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
