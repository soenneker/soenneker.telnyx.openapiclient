...
namespace Soenneker.Telnyx.CampaignBuilder.Brand.Item
{
    ...
    public partial class WithBrandItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithBrandItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/campaignBuilder/brand/{brandId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Telnyx.CampaignBuilder.Brand.Item.WithBrandItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithBrandItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/campaignBuilder/brand/{brandId}", rawUrl)
        {
        }
    }
}
